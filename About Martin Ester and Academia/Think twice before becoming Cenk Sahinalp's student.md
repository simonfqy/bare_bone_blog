...
Nevertheless, even with such issues which can be deal-breakers in most relationships, those issues are less of a concern in academia: if you really want to pursue an academic career, Cenk might still be a good supervisor, which I'll explain in the [Implications for readers](#implications-for-readers) section.
