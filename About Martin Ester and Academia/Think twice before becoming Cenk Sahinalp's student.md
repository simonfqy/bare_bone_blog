...
Nevertheless, even with such issues which can be deal-breakers in most relationships, academia is very different, where those issues are less of a concern: if you really want to pursue an academic career, Cenk might still be a good choice as your supervisor, which I'll explain in the [Implications for readers](#implications-for-readers) section.
...
2. **This incident shows MADD-Gen committee has terrible leadership and execution.** It forms a vicious cycle with the engagement problem: poor leadership and execution can lead to low engagement, while low engagement makes the leadership and execution even weaker.
   1. Being the program chair, why didn't Cenk do anything to prevent or mitigate the issue before it was too late? Isn't this problem completely foreseeable and solvable?
...
3. **This incident shows MADD-Gen committee has problematic work ethics and perhaps morality in general.** As mentioned before, if those professors don't even honor the promises made to the funding agency, what promises will they honor? As for Cenk, if he didn't even ATTEMPT to keep the promise, whose making he took part in, he should be deemed a liar, because making promises you never intend to keep, is a form of lying. It's common sense not to trust liars.
   1. It seems Cenk obviously favored his own interest, so much so that he didn't care about his responsibilities to the program, to the students, and to the funding agency. This shows major problems with work ethics and with overall morality. As the saying goes, "If you see a cockroach in the room, there could be hundreds more hiding." His lack of morality likely emanates in other aspects. What if his research funded by NSERC contains fake data and results? In that case, wouldn't NSERC be an accomplice in academic misconduct? What if he embezzles the NSERC funding?
