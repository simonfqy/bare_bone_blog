...
3. **This shows MADD-Gen committee has problematic work ethics and perhaps morality in general.** As mentioned before, if those professors don't even honor the promises made to the funding agency, what promises will they honor? As for Cenk, he didn't even attempt to keep the promise, which makes him a liar: making promises you have no intention of keeping, is a form of lying. In this case, "defrauder" might be more accurate.
   1. Cenk obviously favored his own interest, so much so that he didn't care about his responsibilities to the program, to the students, and to the funding agency. This is a major problem with work ethics and with overall morality. This lack of morality likely emanates in his other aspects. What if his research funded by NSERC contains spurious data and results? In that case, wouldn't NSERC be an accomplice in academic misconduct? What if he embezzles the funding?
   2. 
